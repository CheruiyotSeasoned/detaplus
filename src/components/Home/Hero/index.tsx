...
const WavyArrow = () => (
  <svg
    ...
    className="text-[#814AC8] dark:text-[#9D6EDB]"
  >
    <defs>
    ...
    <section className="bg-header dark:bg-[#0B1220] pt-36 pb-24 overflow-hidden">
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h3 className="text-midnight_text dark:text-white text-2xl md:text-3xl xl:text-4xl font-bold leading-tight">
            Company Formation, Crypto, Gambling & FinTech Licenses
            <span className="text-[#814AC8] dark:text-[#9D6EDB]"> Licenses</span>
          </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10">
            <button className="bg-[#814AC8] dark:bg-[#814AC8] text-white text-lg font-semibold py-4 px-8 rounded-full transition hover:bg-[#6B3DAD] dark:hover:bg-[#9D6EDB]">
              Get professional advice
            </button>

            <button className="border-2 border-[#814AC8] dark:border-[#9D6EDB] text-[#814AC8] dark:text-white text-lg font-semibold py-4 px-8 rounded-full transition hover:bg-[#814AC8] hover:text-white dark:hover:bg-[#814AC8]">
              Explore all services
            </button>
          </div>

          <div className="mt-6 text-sm text-white/100 dark:text-white">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 mt-20 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-white/100 dark:text-white mt-2">
